...
- unit tests
  ...
  - run_commit_phase
    - check that run_commit_phase works correctly; specifically, it returns the
      ...
      the peers.
      - append to peer0 committed instances at index 1, 2, and 3
      - append to peer1 committed instances at index 1, 2, and 3
      - append to peer2 committed instances at index 1 and 2
