...
- unit tests
  ...
  - commit-until-higher-ballot
    - append entries at indexes 1, 2, and 3, and call commit_until with a higher
      ballot number and leader_last_executed = 3, ensure that none of the
      entries committed and the log is not executable.
