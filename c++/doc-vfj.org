...
- tail_
  ...
  - reading threads:
    - request(accept), handler(heartbeat_handler)
  - writing threads:
    - request(accept)
...
- leader_
  ...
  - reading threads:
    - main, request(accept, prepare, prepare_thread, heartbeat)
  - writing threads:
    - request(accept,prepare), handler(accept_handler, prepare_handler, heartbeat_handler)
...
- ready_
  ...
  - reading threads:
    - main(agree_and_execute)
  - writing threads:
    - request(prepare_thread)
...
- round_
  ...
  - reading threads:
    - request(accept), handler(accept_handler, prepare_handler, heartbeat_handler)
  - writing threads:
    - request(prepare)
